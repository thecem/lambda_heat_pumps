...
async def _handle_update_room_temperature(hass: HomeAssistant, call: ServiceCall) -> None:
...
async def _write_room_and_pv_for_entry(hass: HomeAssistant, entry_id: str, entry_data: dict) -> None:
